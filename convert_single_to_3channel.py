...
if __name__ == "__main__":
    input_directory = "/mnt/data1/zhangjh/ultralytics_zjh/datasets/acdc/train/images_1"  # 替换为你的输入文件夹路径
    output_directory = "/mnt/data1/zhangjh/ultralytics_zjh/datasets/acdc/train/images_3"  # 替换为你的输出文件夹路径
